...
<head>
    ...
    <link rel="stylesheet" href="style/styleforwoman.css">
</head>
<body>
...
<main>
    ...
    <img src="img/woman/boots/1.png" class="boots-img" id="boots-animation"><br>
    <img src="img/woman/hoodie/5.png" class="hoodie-img" id="hoodie-animation"><br>
    <img src="img/woman/pants/5.png" class="pants-img" id="pants-animation">
...
<form action="vvod2.php" method="post">
    ...
    <div class="blockboots" id="blockboots">
        ...
        <?php 
            ...
            $stmt = $pdo->query("SELECT * FROM products WHERE `type` = 'boots' AND `category_of_people` = 'woman'");
            $count = 0;
    ...
    <div class="blockhoodie" id="blockhoodie">
        ...
        <?php 
            ...
            $stmt = $pdo->query("SELECT * FROM products WHERE `type` = 'hoodie' AND `category_of_people` = 'woman'");
            $count = 0;
    ...
    <div class="blockpants" id="blockpants">
        ...
        <?php 
            ...
            $stmt = $pdo->query("SELECT * FROM products WHERE `type` = 'pants' AND `category_of_people` = 'woman'");
            $count = 0;
